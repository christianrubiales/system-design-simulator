...
export const PROBLEMS: Problem[] = [
  {
    ...
    referenceSolution: {
      ...
      edges: [
        ...
        { source: "load-balancer", target: "waf" },
        { source: "waf", target: "app-server" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 580, y: 460 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
        ...
        { source: "pub-sub", target: "lambda" },
        { source: "lambda", target: "nosql-db" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 600, y: 360 },
      ],
      edges: [
        { source: "dns", target: "load-balancer" },
        { source: "load-balancer", target: "api-gateway" },
        ...
        { source: "app-server", target: "monitoring" },
        { source: "message-queue", target: "lambda" },
        { source: "lambda", target: "nosql-db" },
      ],
    },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 675, y: 385 },
      ],
      edges: [
        { source: "dns", target: "load-balancer" },
        { source: "load-balancer", target: "api-gateway" },
        ...
        { source: "stream-processor", target: "lambda" },
        { source: "lambda", target: "nosql-db" },
        { source: "lambda", target: "geospatial-index" },
      ],
    },
  ...
  },
  {
    ...
    referenceSolution: {
      ...
      edges: [
        ...
        { source: "app-server", target: "monitoring" },
        { source: "app-server", target: "stream-processor" },
        { source: "stream-processor", target: "ecs" },
        { source: "ecs", target: "object-storage" },
      ],
    },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "monitoring", x: 850, y: 200 },
        { componentId: "lambda", x: 600, y: 485 },
      ],
      edges: [
        { source: "dns", target: "load-balancer" },
        { source: "load-balancer", target: "api-gateway" },
        ...
        { source: "app-server", target: "monitoring" },
        { source: "message-queue", target: "lambda" },
        { source: "lambda", target: "notification-service" },
      ],
    },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 500, y: 385 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "monitoring", x: 850, y: 250 },
        { componentId: "lambda", x: 675, y: 320 },
      ],
      edges: [
        { source: "dns", target: "load-balancer" },
        { source: "load-balancer", target: "api-gateway" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 800, y: 480 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 720, y: 310 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "monitoring", x: 880, y: 250 },
        { componentId: "lambda", x: 625, y: 480 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "sql-db", x: 700, y: 250 },
        { componentId: "monitoring", x: 700, y: 100 },
        { componentId: "lambda", x: 600, y: 385 },
      ],
      edges: [
        { source: "dns", target: "load-balancer" },
        { source: "load-balancer", target: "api-gateway" },
  ...
  },
  {
    ...
    referenceSolution: {
      ...
      edges: [
        ...
        { source: "app-server", target: "monitoring" },
        { source: "message-queue", target: "ecs" },
        { source: "ecs", target: "object-storage" },
      ],
    },
    tags: ["CDN", "Media", "Feed"],
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "search", x: 720, y: 420 },
        { componentId: "monitoring", x: 880, y: 250 },
        { componentId: "lambda", x: 625, y: 395 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 625, y: 445 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 800, y: 440 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
        ...
        { source: "app-server", target: "monitoring" },
        { source: "message-queue", target: "lambda" },
        { source: "lambda", target: "search" },
        { source: "lambda", target: "object-storage" },
      ],
    },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 520, y: 350 },
      ],
      edges: [
        { source: "load-balancer", target: "api-gateway" },
        { source: "api-gateway", target: "auth-service" },
        ...
        { source: "app-server", target: "monitoring" },
        { source: "message-queue", target: "lambda" },
        { source: "lambda", target: "timeseries-db" },
      ],
    },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "monitoring", x: 880, y: 250 },
        { componentId: "lambda", x: 720, y: 370 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "stream-processor", x: 720, y: 420 },
        { componentId: "monitoring", x: 880, y: 250 },
        { componentId: "lambda", x: 720, y: 420 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      ...
      edges: [
        ...
        { source: "app-server", target: "monitoring" },
        { source: "message-queue", target: "lambda" },
        { source: "lambda", target: "sharded-counter" },
        { source: "lambda", target: "nosql-db" },
      ],
    },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 625, y: 420 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "msk", x: 720, y: 420 },
        { componentId: "monitoring", x: 880, y: 300 },
        { componentId: "ecs", x: 720, y: 420 },
      ],
      edges: [
        { source: "dns", target: "cdn" },
        { source: "dns", target: "load-balancer" },
        ...
        { source: "app-server", target: "object-storage" },
        { source: "app-server", target: "monitoring" },
        { source: "app-server", target: "msk" },
        { source: "msk", target: "ecs" },
        { source: "ecs", target: "search" },
      ],
    },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "monitoring", x: 880, y: 250 },
        { componentId: "lambda", x: 720, y: 320 },
      ],
      edges: [
        { source: "dns", target: "load-balancer" },
        { source: "load-balancer", target: "api-gateway" },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "lambda", x: 520, y: 480 },
        { componentId: "ecs", x: 700, y: 500 },
      ],
      edges: [
        { source: "load-balancer", target: "api-gateway" },
        { source: "api-gateway", target: "app-server" },
        ...
        { source: "app-server", target: "message-queue" },
        { source: "app-server", target: "sql-db" },
        { source: "task-scheduler", target: "ecs" },
        { source: "ecs", target: "object-storage" },
        { source: "app-server", target: "monitoring" },
        { source: "message-queue", target: "lambda" },
        { source: "lambda", target: "task-scheduler" },
      ],
    },
