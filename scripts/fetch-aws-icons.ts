...
const PACK_NAMES: Record<string, string> = {
  ...
  // --- Extended catalog ---
  "transit-gateway": "Arch_AWS-Transit-Gateway_48",
  "direct-connect": "Arch_AWS-Direct-Connect_48",
  batch: "Arch_AWS-Batch_48",
  "app-runner": "Arch_AWS-App-Runner_48",
  beanstalk: "Arch_AWS-Elastic-Beanstalk_48",
  lightsail: "Arch_Amazon-Lightsail_48",
  "auto-scaling": "Arch_Amazon-EC2-Auto-Scaling_48",
  ecr: "Arch_Amazon-Elastic-Container-Registry_48",
  backup: "Arch_AWS-Backup_48",
  fsx: "Arch_Amazon-FSx_48",
  ses: "Arch_Amazon-Simple-Email-Service_48",
  mq: "Arch_Amazon-MQ_48",
  emr: "Arch_Amazon-EMR_48",
  shield: "Arch_AWS-Shield_48",
  acm: "Arch_AWS-Certificate-Manager_48",
  cloudtrail: "Arch_AWS-CloudTrail_48",
  "systems-manager": "Arch_AWS-Systems-Manager_48",
  organizations: "Arch_AWS-Organizations_48",
  bedrock: "Arch_Amazon-Bedrock_48",
  sagemaker: "Arch_Amazon-SageMaker_48",
  rekognition: "Arch_Amazon-Rekognition_48",
  textract: "Arch_Amazon-Textract_48",
  "iot-core": "Arch_AWS-IoT-Core_48",
  mediaconvert: "Arch_AWS-Elemental-MediaConvert_48",
  codepipeline: "Arch_AWS-CodePipeline_48",
  codebuild: "Arch_AWS-CodeBuild_48",
  codedeploy: "Arch_AWS-CodeDeploy_48",
  amplify: "Arch_AWS-Amplify_48",
};
